            ...
            <div style="padding:18px 20px;display:grid;grid-template-columns:1fr auto;gap:20px;">
                ...
                <div style="width:260px;flex-shrink:0;">
                    ...
                    <div style="background:linear-gradient(135deg,#fff7ed,#ffedd5);border:1.5px solid #fed7aa;border-radius:14px;padding:14px;">
                        ...
                        @if($user['subscription']['receipt'])
                        <a href="/storage/{{ $user['subscription']['receipt'] }}" target="_blank" style="margin-top:10px;display:inline-flex;align-items:center;gap:5px;color:#ea580c;font-size:0.75rem;font-weight:600;text-decoration:none;">
