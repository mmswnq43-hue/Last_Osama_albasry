        ...
        <div class="modal-box" style="max-width:500px;">
            <div style="background:linear-gradient(135deg,#f59e0b,#d97706);padding:20px 24px;display:flex;align-items:center;justify-content:space-between;">
                <div style="display:flex;align-items:center;gap:12px;">
                    ...
                    <h3 style="font-weight:700;color:white;font-size:1rem;">تعديل بيانات العميل</h3>
                </div>
                <button wire:click="closeModal" style="background:rgba(255,255,255,0.2);border:none;border-radius:8px;padding:6px;cursor:pointer;color:white;display:flex;">
                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                </button>
            ...
            <div style="padding:22px 24px;display:flex;flex-direction:column;gap:14px;">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    ...
                    <div>
                        <label style="display:block;color:#374151;font-size:0.82rem;font-weight:600;margin-bottom:5px;">نوع المركبة</label>
                        <input wire:model="editForm.vehicle_type" type="text" class="input-field" autocomplete="off">
                    </div>
                    <div>
                        <label style="display:block;color:#374151;font-size:0.82rem;font-weight:600;margin-bottom:5px;">رقم المحرك</label>
                        <input wire:model="editForm.engine_number" type="text" class="input-field" dir="ltr" autocomplete="off">
                    </div>
                </div>
            </div>
            <div style="padding:14px 24px;background:#fffbeb;border-top:1px solid #f1f5f9;display:flex;gap:10px;justify-content:flex-end;">
                <button wire:click="closeModal" style="padding:9px 20px;color:#64748b;border:1.5px solid #e2e8f0;border-radius:10px;font-size:0.875rem;font-weight:600;cursor:pointer;background:white;font-family:'Tajawal',sans-serif;">إلغاء</button>
                <button wire:click="updateUser" wire:loading.attr="disabled" style="padding:9px 24px;background:linear-gradient(135deg,#f59e0b,#d97706);color:white;border:none;border-radius:10px;font-size:0.875rem;font-weight:600;cursor:pointer;font-family:'Tajawal',sans-serif;">
                    <span wire:loading.remove wire:target="updateUser">حفظ التعديلات</span>
                    <span wire:loading wire:target="updateUser">جاري الحفظ...</span>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay">
        <div class="modal-box" style="max-width:420px;">
            <div style="padding:32px 24px;text-align:center;">
                ...
                <p style="color:#64748b;font-size:0.875rem;margin-bottom:24px;">هل أنت متأكد من حذف هذا العميل؟ لا يمكن التراجع عن هذا الإجراء.</p>
                <div style="display:flex;gap:10px;justify-content:center;">
                    ...
                    <button wire:click="deleteUser" wire:loading.attr="disabled" style="padding:10px 24px;background:linear-gradient(135deg,#ef4444,#dc2626);color:white;border:none;border-radius:10px;font-size:0.875rem;font-weight:600;cursor:pointer;font-family:'Tajawal',sans-serif;">
                        <span wire:loading.remove wire:target="deleteUser">نعم، احذف</span>
